Public Class frmQuestionModify
    ...
    Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        ...
        Dim lines() As String = System.IO.File.ReadAllLines("Questions.txt")

        'writes the new question over the selected question and updates the question list
        Try
            lines(frmModify.lstCurrentQuestions.SelectedIndex) = txtModifiedQ.Text

            System.IO.File.WriteAllLines("Questions.txt", lines)
